// /*
//  * GLib 渐进式教学示例 - 合并版
//  * 严格遵循 GLib/GObject/GIO 官方文档规范
//  *
//  * 编译: gcc -o glib-tutorial.exe main.c `pkg-config --cflags --libs glib-2.0 gobject-2.0 gio-2.0`
//  * 运行: ./glib-tutorial [章节号]
//  */
//
// #include <glib.h>
...
//
// /* 第一部分：GLib 核心 */
// void chapter1_data_types_test(void);
...
//  * 第1章：数据类型示例
//  * 展示 GLib 基础数据类型的使用方法
//  * 参考：GLib Reference Manual - Basic Types
//  * ============================================================ */
// void chapter1_data_types_test(void)
// {
//     g_print("\n=== 第1章：数据类型示例 ===\n");
//
//     /* gint - GLib 对应 C 语言 int 的类型 */
//     gint age = 25;
//     g_print("gint age = %d\n", age);
//
//     /* guint - 无符号整型 */
//     guint count = 100;
//     g_print("guint count = %u\n", count);
//
//     /* glong / gulong - 长整型 */
//     glong big_num = 123456789L;
//     g_print("glong big_num = %ld\n", big_num);
//
//     /* gchar - GLib 对应 char 的类型 */
//     gchar ch = 'A';
//     g_print("gchar ch = %c\n", ch);
//
...
//     g_print("gboolean is_valid = %s\n", is_valid ? "TRUE" : "FALSE");
//     g_print("gboolean is_empty = %s\n", is_empty ? "TRUE" : "FALSE");
//
//     /* gpointer / gconstpointer - 通用指针类型 */
//     gint value = 42;
//     gpointer ptr = &value;
//     g_print("gpointer 指向值: %d\n", *(gint *)ptr);
//
//     /* gsize / gssize - 与 sizeof 对应的无符号/有符号类型 */
...
//     gint8  i8  = 127;
//     gint16 i16 = 32767;
//     gint32 i32 = 2147483647;
//     gint64 i64 = G_GINT64_CONSTANT(9223372036854775807);
...
//     guint64 u64 = G_GUINT64_CONSTANT(18446744073709551615);
//     g_print("guint8 = %u, guint16 = %u, guint32 = %u\n", u8, u16, u32);
//     g_print("guint64 = %" G_GUINT64_FORMAT "\n", u64);
//
//     /* gfloat / gdouble - 浮点类型 */
//     gfloat  f = 3.14f;
//     gdouble d = 3.141592653589793;
//     g_print("gfloat = %.2f, gdouble = %.15f\n", f, d);
//
//     /* G_MININT/G_MAXINT 等边界宏 */
//     g_print("G_MININT = %d, G_MAXINT = %d\n", G_MININT, G_MAXINT);
//     g_print("G_MAXUINT = %u\n", G_MAXUINT);
// }
//
// /* ============================================================
